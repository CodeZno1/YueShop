...
<head>
    ...
    <Hi:TemplateStyle ID="Style2" runat="server" Href="/style/nav.css?v=3.0"></Hi:TemplateStyle>
    ...
    <Hi:TemplateStyle ID="RegionStyle" runat="server" Href="/style/region.css?v=3.0"></Hi:TemplateStyle>
    ...
    <Hi:TemplateStyle ID="Style3" runat="server" Href="/style/home.css?v=3.0"></Hi:TemplateStyle>
