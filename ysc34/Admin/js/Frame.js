                ...
                if (CheckAuthorization(authorization)) {
                    ...
                    if (Ispromote == "0") {
                        ...
                        if ($(this).attr("Title") == "商品配置") {
                            $menuaspan = $("<span>" + $(this).attr("Title") + "</span><a title=\"帮助文档\" href='http://download.92hi.com/bangzhuzhongxin/changjianwenti/商品类型与商品分类的区别.pdf' target=\'_blank\' style='display: block;position: absolute;margin:0;top:0;left: 79px;border-left: none;'><img src='images/ic_query.png' /></a>"); //获取二级分类名称"
                        }
                        else {
