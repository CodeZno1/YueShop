            ...
            <div class="formitem">
                <ul>
                    ...
                    <li><span class="formitemtitle ">内容模板：</span>
                        <asp:TextBox TextMode="MultiLine" ID="txtContent" runat="server" Width="550px" Height="200px" ReadOnly="true" Enabled="true" CssClass="forminput form-control"></asp:TextBox>
