	...
	public static class Globals
	{
		...
		public static bool IsTestDomain
		{
			get
			{
				...
				{
					if (Globals.DomainName.EndsWith("xm.kuaidiantong.cn") || Globals.DomainName.StartsWith("localhost") || Globals.DomainName.StartsWith("127.0.0.1") || Globals.DomainName.Contains("ysctest.kuaidiantong.cn") || Globals.DomainName.Contains("yscssl.kuaidiantong.cn"))
					{
						return true;
					}
					return false;
