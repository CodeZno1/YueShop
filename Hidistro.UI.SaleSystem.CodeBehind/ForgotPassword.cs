...
namespace Hidistro.UI.SaleSystem.CodeBehind
{
	public class ForgotPassword : HtmlTemplatedWebControl
	{
		...
		private void btnSendMobile_Click(object sender, EventArgs e)
		{
			...
			if (memberInfo != null)
			{
				string str = HiContext.Current.CreatePhoneCode(6, memberInfo.CellPhone, VerifyCodeType.Digital);
				string text = default(string);
				SendStatus sendStatus = Messenger.SendSMS(memberInfo.CellPhone, "您本次的验证码是:" + str, siteSettings, out text);
