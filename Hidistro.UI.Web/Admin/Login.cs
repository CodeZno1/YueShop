	...
	public class Login : Page
	{
		...
		protected override void Render(HtmlTextWriter writer)
		{
			...
			else
			{
				...
				try
				{
					text2 = APIHelper.PostData("http://ysc.kuaidiantong.cn/valid.ashx", "action=serverstatus&product=2&version=5.8&host=" + Globals.DomainName);
